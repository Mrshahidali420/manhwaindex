...
export function unavailable(astro, error) {
  ...
  const body =
    ...
    '<style>body{font:16px/1.5 system-ui,sans-serif;margin:0;min-height:100vh;display:grid;place-items:center;background:#0b0d12;color:#e8e6df}main{max-width:32rem;padding:2rem}h1{font-size:1.4rem;margin:0 0 .5rem}p{margin:0 0 1rem;opacity:.8}a{color:#f2b544}</style>' +
